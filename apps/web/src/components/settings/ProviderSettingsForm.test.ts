...
describe("ProviderSettingsForm helpers", () => {
  it("presents OMP as the default provider with its managed agent-directory setting", () => {
    expect(PROVIDER_CLIENT_DEFINITIONS[0]?.value).toBe(ProviderDriverKind.make("omp"));
