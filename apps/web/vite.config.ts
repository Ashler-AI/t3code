...
const configuredSessionFabricRelayUrl = repoEnv.VITE_T3CODE_SESSION_FABRIC_RELAY_URL?.trim() || "";
...
export default defineConfig(() => {
  return {
    ...
    define: {
      ...
      "import.meta.env.VITE_T3CODE_SESSION_FABRIC_RELAY_URL": JSON.stringify(
