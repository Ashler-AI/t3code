...
import { prepareAshlerOmpModelsOverlay } from "../../ashler/OmpModelsOverlay.ts";
...
export const OmpDriver: ProviderDriver<OmpSettings, OmpDriverEnv> = {
  ...
  create: ({ instanceId, displayName, accentColor, environment, enabled, config }) =>
    Effect.gen(function* () {
      ...
      const overlay = yield* prepareAshlerOmpModelsOverlay(config, baseProcessEnv);
      const processEnv = overlay.environment;
