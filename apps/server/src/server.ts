...
import { SessionTransferSource } from "@t3tools/contracts";
...
import * as SessionFabricRunner from "./sessionFabric/SessionFabricRunner.ts";
...
const ReactorLayerLive = Layer.empty.pipe(
  ...
  Layer.provideMerge(SessionFabricRunner.layer),
...
export const makeServerLayer = Layer.unwrap(
  Effect.gen(function* () {
    ...
    const serverApplicationLayer = Layer.mergeAll(
      HttpRouter.serve(Layer.mergeAll(makeRoutesLayer, SessionTransferRoutesLive), {
