...
import Migration0036 from "./Migrations/035_ScaffoldSessionTransferFences.ts";
import Migration0037 from "./Migrations/036_ScaffoldWorkspaceMigrationOperations.ts";
import Migration0038 from "./Migrations/038_ProjectionThreadTitleRegenerationCompatibility.ts";
...
export const migrationEntries = [
  ...
  [36, "ScaffoldSessionTransferFences", Migration0036],
  [37, "ScaffoldWorkspaceMigrationOperations", Migration0037],
  [38, "ProjectionThreadTitleRegenerationCompatibility", Migration0038],
] as const;
