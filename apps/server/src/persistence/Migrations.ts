...
import Migration0035 from "./Migrations/035_ScaffoldSessionTransferFences.ts";
import Migration0036 from "./Migrations/036_ScaffoldWorkspaceMigrationOperations.ts";
...
export const migrationEntries = [
  ...
  [35, "ScaffoldSessionTransferFences", Migration0035],
  [36, "ScaffoldWorkspaceMigrationOperations", Migration0036],
] as const;
