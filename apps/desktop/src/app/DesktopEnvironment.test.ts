...
describe("DesktopEnvironment", () => {
  it.effect("derives state paths and development identity inside Effect", () =>
    Effect.gen(function* () {
      ...
      assert.equal(environment.appUserModelId, "ai.ashler.code.dev");
      assert.equal(environment.linuxWmClass, "ashler-code-dev");
      assert.deepEqual(
  ...
  it.effect("keeps implicit development state separate from production state", () =>
    Effect.gen(function* () {
      ...
      assert.equal(development.stateDir, "/Users/alice/.ashler-code/dev");
      assert.equal(production.stateDir, "/Users/alice/.ashler-code/userdata");
    }),
  );
